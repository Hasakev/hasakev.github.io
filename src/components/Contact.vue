...
function openMailClient(payload: { name: string; email: string; message: string }) {
  ...
  window.location.href = `mailto:dev.spam.kev@gmail.com?subject=${subject}&body=${body}`
}
  ...
  <section id="contact">
    ...
    <div class="contact-inner">
      <div class="contact-card">
        ...
        <p class="contact-sub">
          Currently open to new opportunities and collaborations. Whether you have a project in mind, want to chat about software engineering, or just want to say hi, feel free to reach out!
        </p>
